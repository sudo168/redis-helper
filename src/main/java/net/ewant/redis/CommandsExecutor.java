...
public class CommandsExecutor implements RedisCommands{
	...
	public String select(int index) throws Exception {
		...
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [select] in " + sources.getClass().getName());
		}
	}
	...
	public String echo(String string) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [echo] in " + sources.getClass().getName());
		}
	}
	...
	public Long getDB() throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [getDB] in " + sources.getClass().getName());
		}
	}
	...
	public String psetex(String key, long milliseconds, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [psetex] in " + sources.getClass().getName());
		}
	}
	...
	public Long del(String... key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [del] in " + sources.getClass().getName());
		}
	}
	...
	public Boolean exists(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [exists] in " + sources.getClass().getName());
		}
	}
	...
	public Long expire(String key, int seconds) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [expire] in " + sources.getClass().getName());
		}
	}
	...
	public Long expireAt(String key, long unixTime) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [expireAt] in " + sources.getClass().getName());
		}
	}
	...
	public Long move(String key, int dbIndex) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [move] in " + sources.getClass().getName());
		}
	}
	...
	public Long persist(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [persist] in " + sources.getClass().getName());
		}
	}
	...
	public Long pexpire(String key, long seconds) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [pexpire] in " + sources.getClass().getName());
		}
	}
	...
	public Long pexpireAt(String key, long millisecondsTimestamp) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [pexpireAt] in " + sources.getClass().getName());
		}
	}
	...
	public Long pttl(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [pttl] in " + sources.getClass().getName());
		}
	}
	...
	public Long ttl(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [ttl] in " + sources.getClass().getName());
		}
	}
	...
	public Long append(String key, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [append] in " + sources.getClass().getName());
		}
	}
	...
	public Long bitcount(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [bitcount] in " + sources.getClass().getName());
		}
	}
	...
	public Long bitpos(String key, boolean value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [bitpos] in " + sources.getClass().getName());
		}
	}
	...
	public Long decr(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [decr] in " + sources.getClass().getName());
		}
	}
	...
	public Long decrBy(String key, long decrement) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [decrBy] in " + sources.getClass().getName());
		}
	}
	...
	public String get(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [get] in " + sources.getClass().getName());
		}
	}
	...
	public Boolean getbit(String key, long offset) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [getbit] in " + sources.getClass().getName());
		}
	}
	...
	public String getRange(String key, long startOffset, long endOffset) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [getrange] in " + sources.getClass().getName());
		}
	}
	...
	public String getSet(String key, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [getSet] in " + sources.getClass().getName());
		}
	}
	...
	public Long incr(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [incr] in " + sources.getClass().getName());
		}
	}
	...
	public Long incrBy(String key, long increment) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [incrBy] in " + sources.getClass().getName());
		}
	}
	...
	public Double incrByFloat(String key, double increment) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [incrByFloat] in " + sources.getClass().getName());
		}
	}
	...
	public String set(String key, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [set] in " + sources.getClass().getName());
		}
	}
	...
	public Long setNx(String key, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [setnx] in " + sources.getClass().getName());
		}
	}
	...
	public String setEx(String key, int seconds, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [setex] in " + sources.getClass().getName());
		}
	}
	...
	public Boolean setbit(String key, long offset, boolean value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [setbit] in " + sources.getClass().getName());
		}
	}
	...
	public Long setRange(String key, long offset, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [setrange] in " + sources.getClass().getName());
		}
	}
	...
	public Long strlen(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [strlen] in " + sources.getClass().getName());
		}
	}
	...
	public Long hset(String key, String field, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hset] in " + sources.getClass().getName());
		}
	}
	...
	public String hget(String key, String field) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hget] in " + sources.getClass().getName());
		}
	}
	...
	public Long hsetnx(String key, String field, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hsetnx] in " + sources.getClass().getName());
		}
	}
	...
	public String hmset(String key, Map<String, String> hash) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hmset] in " + sources.getClass().getName());
		}
	}
	...
	public List<String> hmget(String key, String... fields) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hmget] in " + sources.getClass().getName());
		}
	}
	...
	public Long hincrBy(String key, String field, long value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hincrBy] in " + sources.getClass().getName());
		}
	}
	...
	public Double hincrByFloat(String key, String field, double value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hincrByFloat] in " + sources.getClass().getName());
		}
	}
	...
	public Boolean hexists(String key, String field) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hexists] in " + sources.getClass().getName());
		}
	}
	...
	public Long hdel(String key, String... fields) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hdel] in " + sources.getClass().getName());
		}
	}
	...
	public Long hlen(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hlen] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> hkeys(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hkeys] in " + sources.getClass().getName());
		}
	}
	...
	public List<String> hvals(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hvals] in " + sources.getClass().getName());
		}
	}
	...
	public Map<String, String> hgetAll(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hgetAll] in " + sources.getClass().getName());
		}
	}
	...
	public Long lpush(String key, String... values) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lpush] in " + sources.getClass().getName());
		}
	}
	...
	public Long llen(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [llen] in " + sources.getClass().getName());
		}
	}
	...
	public List<String> lrange(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lrange] in " + sources.getClass().getName());
		}
	}
	...
	public String ltrim(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [ltrim] in " + sources.getClass().getName());
		}
	}
	...
	public String lindex(String key, long index) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lindex] in " + sources.getClass().getName());
		}
	}
	...
	public String lset(String key, long index, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lset] in " + sources.getClass().getName());
		}
	}
	...
	public Long lrem(String key, long count, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lrem] in " + sources.getClass().getName());
		}
	}
	...
	public String lpop(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lpop] in " + sources.getClass().getName());
		}
	}
	...
	public Long lpushx(String key, String... values) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [lpushx] in " + sources.getClass().getName());
		}
	}
	...
	public List<String> blpop(int timeout, String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [blpop] in " + sources.getClass().getName());
		}
	}
	...
	public List<String> brpop(int timeout, String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [brpop] in " + sources.getClass().getName());
		}
	}
	...
	public String rpop(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [rpop] in " + sources.getClass().getName());
		}
	}
	...
	public Long rpushx(String key, String... values) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [rpushx] in " + sources.getClass().getName());
		}
	}
	...
	public Long linsertBefore(String key, String pivot, String value) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [linsert] in " + sources.getClass().getName());
		}
	}
	...
	public Long sadd(String key, String... members) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [sadd] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> smembers(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [smembers] in " + sources.getClass().getName());
		}
	}
	...
	public Long srem(String key, String... members) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [srem] in " + sources.getClass().getName());
		}
	}
	...
	public String spop(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [spop] in " + sources.getClass().getName());
		}
	}
	...
	public Long scard(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [scard] in " + sources.getClass().getName());
		}
	}
	...
	public Boolean sismember(String key, String member) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [sismember] in " + sources.getClass().getName());
		}
	}
	...
	public String srandmember(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [srandmember] in " + sources.getClass().getName());
		}
	}
	...
	public Long zadd(String key, double score, String member) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zadd] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> zrange(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrange] in " + sources.getClass().getName());
		}
	}
	...
	public Long zrem(String key, String... members) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrem] in " + sources.getClass().getName());
		}
	}
	...
	public Double zincrby(String key, double score, String member) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zincrby] in " + sources.getClass().getName());
		}
	}
	...
	public Long zrank(String key, String member) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrank] in " + sources.getClass().getName());
		}
	}
	...
	public Long zrevrank(String key, String member) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrevrank] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> zrevrange(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrevrange] in " + sources.getClass().getName());
		}
	}
	...
	public Set<Map<String, Double>> zrangeWithScores(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrangeWithScores] in " + sources.getClass().getName());
		}
	}
	...
	public Set<Map<String, Double>> zrevrangeWithScores(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrevrangeWithScores] in " + sources.getClass().getName());
		}
	}
	...
	public Long zcard(String key) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zcard] in " + sources.getClass().getName());
		}
	}
	...
	public Double zscore(String key, String member) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zscore] in " + sources.getClass().getName());
		}
	}
	...
	public Long zcount(String key, double min, double max) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zcount] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> zrangeByScore(String key, double min, double max) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrangeByScore] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> zrevrangeByScore(String key, double max, double min) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrevrangeByScore] in " + sources.getClass().getName());
		}
	}
	...
	public Set<Map<String, Double>> zrangeByScoreWithScores(String key, double min, double max) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrangeByScoreWithScores] in " + sources.getClass().getName());
		}
	}
	...
	public Set<Map<String, Double>> zrevrangeByScoreWithScores(String key, double max, double min) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrevrangeByScoreWithScores] in " + sources.getClass().getName());
		}
	}
	...
	public Long zremrangeByRank(String key, long start, long end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zremrangeByRank] in " + sources.getClass().getName());
		}
	}
	...
	public Long zremrangeByScore(String key, double start, double end) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zremrangeByScore] in " + sources.getClass().getName());
		}
	}
	...
	public Long zlexcount(String key, String min, String max) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zlexcount] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> zrangeByLex(String key, String min, String max) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrangeByLex] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> zrevrangeByLex(String key, String max, String min) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zrevrangeByLex] in " + sources.getClass().getName());
		}
	}
	...
	public Long zremrangeByLex(String key, String min, String max) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [zremrangeByLex] in " + sources.getClass().getName());
		}
	}
	...
	public Long hdelByRename(String routeKey, String dataKey, String... fields) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hdelByRename] in " + sources.getClass().getName());
		}
	}
	...
	public String hgetByRename(String routeKey, String dataKey, String field) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hgetByRename] in " + sources.getClass().getName());
		}
	}
	...
	public Set<String> hkeysByRename(String routeKey, String dataKey) throws Exception {
		if(sources instanceof Jedis){
			...
			throw new IllegalAccessException("not support command [hkeysByRename] in " + sources.getClass().getName());
		}
	}
