...
public class DefaultRedisClusterConnection extends AbstractRedisConnection implements RedisClusterConnection {
	...
	public String auth(String password) throws RedisOperationException {
		throw new RedisOperationException("not support command [password] in " + sources.getClass().getName());
	}
	...
	public Map<String, List<String>> scan(String cursor) throws RedisOperationException {
		throw new RedisOperationException("not support command [scan(String cursor)] in " + sources.getClass().getName());
	}
